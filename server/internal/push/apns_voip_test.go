...
func TestAPNSVoIPSendsHTTP2PrivacySafeCallPayloadAndCachesJWT(t *testing.T) {
	...
	server := httptest.NewUnstartedServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if body["callId"] != "call-1" || body["conversationId"] != "conv-1" || body["mediaType"] != "video" || body["nameCaller"] != "青蛙呱呱联系人" || body["handle"] != "青蛙呱呱" || !strings.Contains(string(raw), "content-available") {
