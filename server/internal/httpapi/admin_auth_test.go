...
func TestAdminRolePermissionsAreServerEnforced(t *testing.T) {
	...
	cases := []struct {
		...
		{"moderator", "PUT", "/v2/admin/users/u/friend-login-ip-permission", true},
		{"moderator", "PUT", "/v2/admin/users/friend-login-ip-permissions", true},
		...
		{"system_operator", "PUT", "/v2/admin/users/u/friend-login-ip-permission", false},
...
func TestEveryRegisteredAdminJSONWriteRequiresConfirmationAndReason(t *testing.T) {
	...
	routes := []struct{ method, path string }{
		...
		{http.MethodPut, "/v2/admin/users/u/friend-login-ip-permission"},
		{http.MethodPut, "/v2/admin/users/friend-login-ip-permissions"},
