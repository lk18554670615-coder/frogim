...
func TestAdminRolePermissionsAreServerEnforced(t *testing.T) {
	...
	cases := []struct {
		...
		{"moderator", "PUT", "/v2/admin/users/u/internal-user", true},
		{"moderator", "PUT", "/v2/admin/invite-codes/ic/status", true},
		{"moderator", "PUT", "/v2/admin/users/u/invite-relation", true},
		{"support_agent", "PUT", "/v2/admin/users/u/invite-relation", false},
		{"system_operator", "PUT", "/v2/admin/users/u/invite-relation", false},
		{"moderator", "POST", "/v2/admin/invite-codes/ic/reset", true},
		{"support", "PUT", "/v2/admin/invite-codes/ic/status", false},
		{"system_operator", "PUT", "/v2/admin/users/u/internal-user", false},
		...
		{"system_operator", "PATCH", "/v2/admin/groups/g/settings", false},
		{"platform_admin", "PATCH", "/v2/admin/groups/g/settings", true},
...
func TestEveryRegisteredAdminJSONWriteRequiresConfirmationAndReason(t *testing.T) {
	...
	routes := []struct{ method, path string }{
		...
		{http.MethodPut, "/v2/admin/users/u/internal-user"},
		{http.MethodPut, "/v2/admin/invite-codes/ic/status"},
		{http.MethodPut, "/v2/admin/users/u/invite-relation"},
		...
		{http.MethodPatch, "/v2/admin/groups/g/settings"},
		{http.MethodPost, "/v2/admin/groups/g/avatar/presign"},
		{http.MethodPost, "/v2/admin/groups/g/avatar/m/complete"},
