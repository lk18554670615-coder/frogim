...
function UserManagementCard({ user, canWrite, onFriendIPPermissionChange, onDetail, onRecords, onMessage, onDisposition,onIP }: { user: UserRecord; canWrite: boolean; onFriendIPPermissionChange: (allowed:boolean) => void; onDetail: () => void; onRecords: () => void; onMessage: () => void; onDisposition: () => void;onIP:(ip:string)=>void }) {
  const {notify}=useApi();
