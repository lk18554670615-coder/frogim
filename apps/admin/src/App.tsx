...
import { UserAccessSummary, UserAccessLogPanel, IPAccountsPanel } from './UserAccess';
import type {
...
function messageBodySummary(message: Pick<AdminDirectMessageRecord, 'body' | 'type'>) {
...
function UserManagementCard({ user, canWrite, onDetail, onRecords, onMessage, onDisposition,onIP }: { user: UserRecord; canWrite: boolean; onDetail: () => void; onRecords: () => void; onMessage: () => void; onDisposition: () => void;onIP:(ip:string)=>void }) {
  ...
  return <article className="user-management-card">
    ...
    <dl className="user-card-facts">
      ...
      <div><dt>IP 信息</dt><dd><UserAccessSummary access={user.access} onIP={onIP} notify={notify}/></dd></div>
    </dl>
